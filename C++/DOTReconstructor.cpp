...
void DOTReconstructor::AssembleM()
{
...
void DOTReconstructor::LoadDOTConstants()
{
...
void DOTReconstructor::ComputeP(vnl_vector <float> &S, vnl_vector <float> &P)
{
    ComputeADC(S);
...
void DOTReconstructor::DoReconstruction()
{
    try{
        // step1: prepare data
        LoadInputDataFiles();
